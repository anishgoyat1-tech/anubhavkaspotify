...
async function displayAlbums() {
    let a = await fetch(`https://anubhavkaspotify.vercel.app/songs/`)
    let response = await a.text();
    let div = document.createElement("div");
    div.innerHTML = response;
    console.log(div);
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if(e.href.includes("%5Csongs")){
            ...
            cardContainer.innerHTML = cardContainer.innerHTML + `<div data-folder="https://anubhavkaspotify.vercel.app/songs/${folder}" class="card">
                        <div class="play">
                        ...
                        <img src="https://anubhavkaspotify.vercel.app/songs/${folder}/cover.jpg" alt="">
...
async function main() {
    ...
    await getSongs("https://anubhavkaspotify.vercel.app/songs/happy");
